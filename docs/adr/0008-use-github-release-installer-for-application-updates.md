...
The GitHub update source is fixed to the project repository `maousan/GridReportForm`. The helper checks `https://api.github.com/repos/maousan/GridReportForm/releases/latest` and does not expose the repository as an end-user setting.
